...
8. Append the block to the module's Requirements section as a level-3 heading (`### REQ-ID`), nested under `## Requirements`; if the REQ introduces or changes a route, update the "Exposed routes" table in the same file.
